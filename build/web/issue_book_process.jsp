                ...
                <div class="content_box">
                    ...
                    <td valign="top">
                     ...
                     <%
                            ...
                            int status = RegisterUser1.register1(id, book_name, student_name, student_id, date);

                            if (status>0) {

                                out.print("Issed New Book Successfully.");
                                request.setAttribute("newstaff", "Issed New Book Successfully.");
