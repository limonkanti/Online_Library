    ...
    <body>
        <div id="templatemo_header_wrapper">
            <div id="templatemo_header">
                ...
                </div><p>This is my first project in JAVA EE using JSP and Servlet.</p>
                ...
                <div class="content_box">
                    ...
                    <td valign="top">
                        ...
                        <table><%
                            ...
                            //	if(status==true){
                            try {
                                PreparedStatement ps = con.prepareStatement("delete  from issue_books where student_id = '" + id + "' and book_name='"+bookName+"'");
                  //    delete from issue_books where student_id=? and book_name =?
                                ps.executeUpdate();

                                
                                    out.print("Return book successfully");
                                    request.setAttribute("deleted", "Return book successfully");
                            %>	
                         
                            <jsp:forward page="return_book.jsp"></jsp:forward> 
                            <%
                                   // }
                    ...
                    //}
                        ...
                        <div class="section_w250 float_l">
                            <h3>Core Java</h3>            
                            <p>oops is a concept of core java so.  we must visit,on google  site,to know java in defth.</p>
                        </div>
